describe('Movies', function() {
    ...
    function addMovie(title, release, description) {
        browser().navigateTo(addMovieUrl);
        input('movie.title').enter(title);
        input('movie.release').enter(release);
    ...
    function addTestMovies() {
        ...
        addMovie('The Dark Knight', '1955', 'When Batman, Gordon and Harvey Dent ' +
        ...
        addMovie('The Dark Knight Rises', '1985', 'Eight years on, a new evil rises ' +
        ...
        addMovie('Cloud Atlas', '1975', 'An exploration of how the actions of ' +
            ...
            'revolution.');
        addMovie('Ted', '2011', 'As the result of a childhood wish, John Bennett\'s ' +
        ...
        addMovie('The Meerkats', '2000', 'An inspiring exploration of one family\'s ' +
            'resilience and fortitude shot using innovative and ' +
            'groundbreaking filming techniques.');
        addMovie('Undisputed II: Last Man Standing', '2005', 'Sequel to the 2002 ' +
